@Affiliate_Smoke_SIT_CD
Feature: Smoke Suite for SIT CD Organization

  @PhaseAll1_CD @PhaseAll1 @APUI51_TC4_Aff_CD @Affiliates_Sprint8_CD @Acceptence_5_CD @QASprint8_CD @Smoke1 @Regression1
  ...
  @PhaseAll1_CD @PhaseAll1 @APUI379_TC20_Aff_CD_T21 @Affiliates_Sprint12_CD @Acceptence_1_CD @QASprint12_CD @Smoke1
  ...
  @PhaseAll1_CD @PhaseAll1 @APUI111_TC1_Aff_CD @Affiliates_Sprint8_CD @Acceptence_1_CD @QASprint8_CD @Smoke1 @Regression1
  ...
  @Phase_CD @Phase @APUI85_TC16_Aff_CD @Affiliates_Sprint8_CD @Acceptence_6_CD @QASprint8_CD @Smoke1
  ...
  @PhaseAll1_CD @PhaseAll1 @APUI100_TC2_Aff_CD @Affiliates_Sprint3_CD @Acceptence_1_CD @Affiliates_Regression_Suite_CD @Affiliates_RegressionRun @PhaseAll1_CD @PhaseAll1 @Smoke1
  ...
  @PhaseAll1_CD @PhaseAll1 @APUI270_TC46_Aff_CD @Affiliates_Sprint15_CD @Acceptence_11_CD @Smoke1
...
#PFX Account : Sub Affilate : 10 Records(Including all 3 modules)
  @Phase_CD @Phase @APUI273_TC5_Aff_CD @Affiliates_Sprint12_CD @Acceptence_3_CD @QASprint12_CD @Smoke1
  ...
  @PhaseAll1_CD @PhaseAll1 @APUI328_TC26_Aff_CD @Affiliates_Sprint10_CD @Acceptence_1_CD @QASprint10_CD @Smoke1
  ...
  @Phase_CD @Phase @APUI49_TC32_Aff_CD @Affiliates_Sprint10_CD @Acceptence_4_CD @QASprint11_CD @Smoke1
