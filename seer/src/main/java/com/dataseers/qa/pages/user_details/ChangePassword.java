...
//already used passw0rd error toaster
	...
	public ChangePassword(WebDriver d) {
	...
	public void change_pwd_page() {
		try {
			...
			log.error("User is Not redirected to change passsw0rd page!!!!");
			Assert.fail();
	...
	public void resetPassworddb() throws SQLException {

		String updateQuery = dbprop.getProperty("resetPwd");
		String deleteQuery =  dbprop.getProperty("deletePwdHistory");
		TestUtil.deleteQuerykeydb(updateQuery);
