...
//			String processor = TestUtil.selectquery(dbprop.getProperty("selectProcessor"));
//			log.info(processor);
...
//			ds_Processor_page.editProcessorDetails(processor);
//			ds_Processor_page.editRule();
