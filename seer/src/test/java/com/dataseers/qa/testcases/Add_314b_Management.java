...
import com.dataseers.qa.pages.compliance.Fincen314b;
import com.dataseers.qa.util.TestUtil;

public class Add_314b_Management extends TestUtil
{
	LoginPage  ds_LoginPage;
	Fincen314b ds_Fincen314b;

	public Add_314b_Management() 
	{
		...
		try
			{
				...
				ds_Fincen314b = new Fincen314b(d);
			}
	...
	@Test
	public void Add_ds_Fincen314b_Test() throws InterruptedException, IOException
	{
		try {
				...
				ds_Fincen314b.FinCENPage();
				ds_Fincen314b.Add_Fincen314b_Page();
				ds_Fincen314b.save_Fincen314b();
				Thread.sleep(2000);
//				ds_Fincen314b.cancel_Fincen314b();
			}
		catch(Exception e)
			{
