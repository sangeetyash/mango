...
public class ProgramMatrix_Test1 extends TestUtil {
	...
	@Test
	public void Add_ProgramMatrix_Test() throws InterruptedException, IOException {
		try {
...
//			ds_RegisterPage.proceedtoportal();
			...
			ds_ProgramMatrix_page.addProgramMatrixBtn();
			d.navigate().refresh();
