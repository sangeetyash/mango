...
import com.dataseers.qa.pages.reports.realtimemesseges.CardPage;
import com.dataseers.qa.util.TestUtil;

public class RealTimeCard_Test1 extends TestUtil {

	RegisterPage ds_RegisterPage;
	LoginPage ds_LoginPage;
	CardPage ds_CardPage;

	public RealTimeCard_Test1() {
...
//			ds_RegisterPage.proceedtoportal();
			...
			ds_CardPage.searchDetails();
			ds_CardPage.verifyCardSearch();
			ds_CardPage.verifyCardResponse();
		} catch (Exception e) {
		}
	}
