...
//
//public class AddProcessorRule_Test1 extends TestUtil {
//
//	RegisterPage ds_RegisterPage;
//	LoginPage ds_LoginPage;
//	Processor ds_Processor_page;
//
//	public AddProcessorRule_Test1() {
...
//
//	@Test
//	public void Add_Processor_Test() throws InterruptedException, IOException {
//		try {
//
...
//			ds_Processor_page.selectRule("Batch");
//			ds_Processor_page.frequencyDetails("add", "Daily", "10:10", null, null, null, null);
//			ds_Processor_page.alertDetails("Rupesh Wayal");
//			ds_Processor_page.batchFileDetails("add", "1", "uploads/clients", null, "Company", 0);
