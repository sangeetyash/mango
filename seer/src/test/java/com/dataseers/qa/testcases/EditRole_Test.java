...
public class EditRole_Test extends TestUtil {

	RegisterPage ds_RegisterPage;
	LoginPage ds_LoginPage;
	RoleMgmt ds_Role_Mgmt_Page;

	public EditRole_Test() {
		super();// Calls the TestBase class
		log.info("************************** DS-Seed portal edit new role Page TEST  *****************************");
	}
...
//			ds_RegisterPage.proceedtoportal();
			...
			ds_Role_Mgmt_Page.editRole(roleData);
//			ds_Role_Mgmt_Page.roleName(roleData);
			ds_Role_Mgmt_Page.rolePermissions("Read/Write");
			ds_Role_Mgmt_Page.escalateToDropdowns("Read Write Admin");
